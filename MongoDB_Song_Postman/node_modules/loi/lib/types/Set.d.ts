...
import { LoiFactoryTypeBase } from './Base';
export declare function set<T1 extends string | number | boolean>(t1: T1): LoiFactoryTypeBase<t.Type<T1, T1>>;
export declare function set<T1 extends string | number | boolean, T2 extends string | number | boolean>(t1: T1, t2: T2): LoiFactoryTypeBase<t.Type<T1 | T2, T1 | T2>>;
export declare function set<T1 extends string | number | boolean, T2 extends string | number | boolean, T3 extends string | number | boolean>(t1: T1, t2: T2, t3: T3): LoiFactoryTypeBase<t.Type<T1 | T2 | T3, T1 | T2 | T3>>;
export declare function set<T1 extends string | number | boolean, T2 extends string | number | boolean, T3 extends string | number | boolean, T4 extends string | number | boolean>(t1: T1, t2: T2, t3: T3, t4: T4): LoiFactoryTypeBase<t.Type<T1 | T2 | T3 | T4, T1 | T2 | T3 | T4>>;
export declare function set<T1 extends string | number | boolean, T2 extends string | number | boolean, T3 extends string | number | boolean, T4 extends string | number | boolean, T5 extends string | number | boolean>(t1: T1, t2: T2, t3: T3, t4: T4, t5: T5): LoiFactoryTypeBase<t.Type<T1 | T2 | T3 | T4 | T5, T1 | T2 | T3 | T4 | T5>>;
export declare function set<T1 extends string | number | boolean, T2 extends string | number | boolean, T3 extends string | number | boolean, T4 extends string | number | boolean, T5 extends string | number | boolean, T6 extends string | number | boolean>(t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6): LoiFactoryTypeBase<t.Type<T1 | T2 | T3 | T4 | T5 | T6, T1 | T2 | T3 | T4 | T5 | T6>>;
...
export declare function set<T extends object>(t: T): LoiFactoryTypeBase<t.Type<keyof T, keyof T>>;
