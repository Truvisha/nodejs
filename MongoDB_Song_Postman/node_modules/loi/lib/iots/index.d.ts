import { Either, Predicate } from "./Either";
declare global {
    interface Array<T> {
        _A: T;
    }
...
export declare const refinement: <RT extends Any>(type: RT, predicate: Predicate<TypeOf<RT>>, name?: string) => RefinementType<RT, TypeOf<RT>, OutputOf<RT>, InputOf<RT>>;
...
export declare const array: <RT extends Mixed>(type: RT, name?: string) => ArrayType<RT, TypeOf<RT>[], OutputOf<RT>[], mixed>;
...
export declare const union: <RTS extends Mixed[]>(types: RTS, name?: string) => UnionType<RTS, TypeOf<RTS["_A"]>, OutputOf<RTS["_A"]>, mixed>;
...
export declare function intersection<A extends Mixed, B extends Mixed, C extends Mixed, D extends Mixed, E extends Mixed>(types: [A, B, C, D, E], name?: string): IntersectionType<[
    A,
    B,
    C,
    D,
    E
], TypeOf<A> & TypeOf<B> & TypeOf<C> & TypeOf<D> & TypeOf<E>, OutputOf<A> & OutputOf<B> & OutputOf<C> & OutputOf<D> & OutputOf<E>, mixed>;
export declare function intersection<A extends Mixed, B extends Mixed, C extends Mixed, D extends Mixed>(types: [A, B, C, D], name?: string): IntersectionType<[
    A,
    B,
    C,
    D
], TypeOf<A> & TypeOf<B> & TypeOf<C> & TypeOf<D>, OutputOf<A> & OutputOf<B> & OutputOf<C> & OutputOf<D>, mixed>;
...
export declare function tuple<A extends Mixed, B extends Mixed, C extends Mixed, D extends Mixed, E extends Mixed>(types: [A, B, C, D, E], name?: string): TupleType<[
    A,
    B,
    C,
    D,
...
export declare function tuple<A extends Mixed, B extends Mixed, C extends Mixed, D extends Mixed>(types: [A, B, C, D], name?: string): TupleType<[
    A,
    B,
    C,
    D
...
export declare const readonly: <RT extends Mixed>(type: RT, name?: string) => ReadonlyType<RT, Readonly<TypeOf<RT>>, Readonly<OutputOf<RT>>, mixed>;
...
export declare const readonlyArray: <RT extends Mixed>(type: RT, name?: string) => ReadonlyArrayType<RT, readonly TypeOf<RT>[], readonly OutputOf<RT>[], mixed>;
...
export declare const taggedUnion: <Tag extends string, RTS extends Tagged<Tag, any, any>[]>(tag: Tag, types: RTS, name?: string) => TaggedUnionType<Tag, RTS, TypeOf<RTS["_A"]>, OutputOf<RTS["_A"]>, mixed>;
